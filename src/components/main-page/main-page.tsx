  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to={ROUTES.STRING}>
          <div className={`${styles.card} ${styles.string}`} />
        </Link>
        <Link className={styles.link} to={ROUTES.FIBONACCI}>
          <div className={`${styles.card} ${styles.fibonacci}`} />
        </Link>
        <Link className={styles.link} to={ROUTES.SORTING}>
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link className={styles.link} to={ROUTES.STACK}>
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link className={styles.link} to={ROUTES.QUEUE}>
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link className={styles.link} to={ROUTES.LIST}>
